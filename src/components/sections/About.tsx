        ...
        <div className="max-w-4xl mx-auto text-center">
           ...
           <div className="relative w-full aspect-[21/9] md:aspect-[3/1] rounded-3xl overflow-hidden border border-slate-800 bg-slate-900/80 mb-12 group">
             ...
             <div className="relative w-full h-full overflow-hidden">
                <Image src="/images/about.png" alt="Reuniao institucional da Horizon Prime" fill className="object-cover opacity-60 group-hover:scale-105 transition-transform duration-[1.5s]" sizes="(max-width: 768px) 100vw, 80vw" />
             </div>
           </div>
